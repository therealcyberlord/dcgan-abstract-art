...
``` python Main.py [num_images] [--seed=somenumber] [--checkpoint=somenumber] [--srgan=somenumber]```

eg: ``` python Main.py 104 --seed 90 --checkpoint 120 --srgan 1``` 
...
checkpoint_num $\in$ [70, 100, 120, 150], default: 150
