...
***
the arg values will be in type integer and num_images must be in the range (0, 120], only the argument num_images is required. Try reducing the number of images you are applying super resolution if you are running out of memory.
